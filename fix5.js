...
vpTest = vpTest.replace(/error: "GitHub API rate limit"/g, 'error: "GitHub API rate limit", prUrl: ""');
vpTest = vpTest.replace(/installed: false,\n\s+packageManager: null,/g, 'installed: false,\n      packageManager: "npm",');
