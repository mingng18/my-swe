...
describe("githubCommentTool", () => {
  ...
  it('should handle null or undefined being thrown gracefully', async () => {
    process.env.GITHUB_TOKEN = 'env_token';
    mockPostGithubComment.mockRejectedValue(null);
  ...
  it('should catch and return error if getGithubTokenFromThread throws', async () => {
    delete process.env.GITHUB_TOKEN;
