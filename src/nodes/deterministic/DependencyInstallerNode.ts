...
export async function installDependencies(
	...
	return performInstallation(sandbox, repoDir, packageManager, emitProgress);
}

/**
 * Perform the actual installation of dependencies using the specified package manager.
 */
