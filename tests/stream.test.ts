...
describe("SSE Endpoint", () => {
  ...
  it("should emit events to the stream", async () => {
    ...
    // Emit event directly through streamRegistry
  ...
  it("should handle multiple concurrent streams", async () => {
    ...
    // Note: Stream connections are verified by checking they return 200 below

    // Close all streams using public API
  ...
  it("should cleanup old streams", async () => {
    ...
    // Close the stream using public API
    streamRegistry.closeStream(threadId);
    controller.abort();
