...
## 2025-05-01 - Prevent Command Injection in Blueprint Actions
**Vulnerability:** Command Injection via execFile using untrusted user input from environment variables LINTER_COMMAND and TEST_COMMAND.
**Learning:** System commands constructed from environmental variables provide a pathway for executing unintended code.
**Prevention:** Explicitly restrict allowed executables using an allowlist approach before running execFile.
