...
export const SchemaDisplayPath = ({
  ...
  // Safe way to highlight path parameters by splitting and mapping to React elements
  const renderPath = (pathString: string) => {
    return pathString.split(/(\{.*?\})/).map((part, index) => {
