...
export const SchemaDisplayPath = ({
  ...
  // Avoid dangerouslySetInnerHTML to prevent XSS vulnerabilities from untrusted path data.
  // Instead, split the string and natively render React elements which safely escape content.
  ...
  return (
    <span className={cn("font-mono text-sm", className)} {...props}>
      {parts.map((part, index) => {
        ...
        return part; // React safely escapes text nodes by default
      })}
    </span>
  );
};
