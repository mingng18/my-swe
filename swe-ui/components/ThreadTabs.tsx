          ...
          {threadEntries.map(([threadId, thread]) => (
            ...
            >
              ...
              <button
                ...
                className="absolute right-1.5 top-1/2 -translate-y-1/2 h-5 w-5 p-0 opacity-0 group-hover:opacity-100 focus-visible:opacity-100 focus-visible:ring-2 focus-visible:outline-none hover:bg-destructive/20 hover:text-destructive transition-all rounded-md flex items-center justify-center"
